...
class ProductController extends Controller
{
    ...
    public function create()
    {
        ...
        $taxes = VatTaxRepository::getActiveVatTaxes();

        return view('shop.product.create', compact('brands', 'colors', 'categories', 'units', 'sizes', 'taxes'));
    }
    ...
    public function edit(Product $product)
    {
        ...
        return view('shop.product.edit', compact('product', 'brands', 'colors', 'categories', 'units', 'sizes', 'subCategories', 'taxes', 'metaKeywords'));
    }
