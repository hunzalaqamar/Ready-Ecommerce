    ...
    <div class="main-container py-2 flex items-center justify-between gap-8">
        ...
        <div class="flex items-center gap-8 grow">
            ...
            <div class="relative overflow-hidden grow max-w-[800px] hidden md:block">
                <input type="text" v-model="search" :placeholder="$t('Search product')"
                    class="px-2.5 py-2.5 block rounded-lg border border-slate-200 focus:border-primary w-full placeholder:text-gray-400 outline-none text-base font-normal leading-normal" @keyup.enter="searchProducts()">
                <button class="bg-primary-600 h-full w-14 border-none absolute top-0 flex items-center justify-center" :class="master.langDirection == 'rtl' ? 'left-0 rounded-l-lg' : ' right-0 rounded-r-lg'" @click="searchProducts()">
        ...
        <div class="md:hidden flex items-center gap-4 relative">
            ...
            <button class="pl-1" @click="master.basketCanvas = true">
                <div class="w-6 h-6 relative">
                    <img :src="'/assets/icons/bag.svg'" class="w-6 h-6 text-primary" />
                    <span class="absolute -top-1 -right-1 w-4 h-4 bg-red-500 rounded-full flex items-center justify-center text-white text-xs font-bold">
                        {{ basketStore.total }}
                    </span>
                </div>
            </button>
                                ...
                                <DialogPanel
                                    ...
                                    <div class="bg-white px-4 pb-2 pt-5">
                                        <div class="w-full flex items-center justify-between mb-3 border-b pb-2">
                                            <span>{{ $t('Search') }}</span>
                                            <button type="button" class="border border-slate-100 rounded-full p-1 outline-none"
                                    ...
                                    <DialogPanel class="pointer-events-auto relative w-screen max-w-md">
                                        ...
                                        <div class="flex h-full flex-col overflow-y-scroll bg-white shadow-xl p-4">
                                            ...
                                            <div
                                                ...
                                                <div class="flex justify-between items-center px-3 py-2.5 bg-white rounded-md border border-slate-100 gap-2" @click="showWishlist()">
                                                    <div class="flex items-center gap-2">
                                            ...
                                            <div class="justify-start inline-flex grow flex-col mt-5 gap-2">
                                                <router-link to="/"
                                                    class="py-2 border-b-2 border-slate-200 text-base font-normal text-slate-600">
                                                    {{ $t('Home') }}
                                                </router-link>
