<template>
    <div class="main-container flex items-center justify-between md:gap-3 lg:gap-4 border-t border-b border-slate-100 flex-wrap md:flex-nowrap relative">
        ...
        <!-- Main menu -->
        <div class="hidden md:inline-flex justify-start items-center gap-2.5 lg:gap-3 xl:gap-5  2xl:gap-6 grow">
            <router-link to="/" class="h-9 py-2 border-b-2 border-transparent text-sm lg:text-base font-normal text-slate-600">
                {{ $t('Home') }}
            </router-link>
            ...
            <div class="w-[0px] h-4 border border-slate-200" :class="master.getMultiVendor ? 'hidden lg:block' : ''"></div>

            <router-link to="/blogs"
                class="h-9 py-2 border-b-2 border-transparent text-sm lg:text-base font-normal text-slate-600" :class="master.getMultiVendor ? 'hidden lg:block' : ''">
                {{ $t('Blogs') }}
            </router-link>
        </div>
